...
const HERO: CanPose[] = [
  { pos: [-0.315, -0.1, 0], rot: [0, -0.20, 0.18], scale: 1 },
  { pos: [0.315, -0.14, -0.6], rot: [0, 0.20, -0.28], scale: 0.9 },
...
const HERO_MOBILE: CanPose[] = [
  { pos: [-0.22, -0.06, 0], rot: [0, -0.16, 0.16], scale: 0.95 },
  { pos: [0.22, -0.10, -0.6], rot: [0, 0.16, -0.22], scale: 0.85 },
  { pos: [0.2, 1.0, -1.2], rot: [0, 0, 0.3], scale: 0.02 },
];

/** Cluster: Desktop layout grouped right of centre. */
const CLUSTER: CanPose[] = [
  { pos: [0.12, -0.01, 0.3],  rot: [0, -0.10, 0.05],  scale: 0.6 },
  { pos: [0.28,  0.08, -0.7], rot: [0.03, 0.12, -0.1], scale: 0.5 },
  { pos: [0.06,  0.1, -0.4],  rot: [-0.03, -0.10, 0.1],scale: 0.52 },
  { pos: [0.24, -0.14, 0.05], rot: [0.02, 0.08, -0.14], scale: 0.56 },
];

/** Cluster: Mobile layout centered below headline for perfect vertical balance. */
const CLUSTER_MOBILE: CanPose[] = [
  { pos: [-0.02, -0.16, 0.3],  rot: [0, -0.06, 0.04],  scale: 0.52 },
  { pos: [0.16,  -0.10, -0.7], rot: [0.02, 0.08, -0.08], scale: 0.44 },
  { pos: [-0.16, -0.08, -0.4], rot: [-0.02, -0.06, 0.08],scale: 0.46 },
];
